...
func (_mock *WalletStorageMock) GetTransactionsByWallet(ctx context.Context, network string, txs []Transaction) (map[string][]string, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, []Transaction) (map[string][]string, error)); ok {
		return returnFunc(ctx, network, txs)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, []Transaction) map[string][]string); ok {
...
func (_c *WalletStorageMock_GetTransactionsByWallet_Call) Return(stringToStrings map[string][]string, err error) *WalletStorageMock_GetTransactionsByWallet_Call {
	_c.Call.Return(stringToStrings, err)
	return _c
}

func (_c *WalletStorageMock_GetTransactionsByWallet_Call) RunAndReturn(run func(ctx context.Context, network string, txs []Transaction) (map[string][]string, error)) *WalletStorageMock_GetTransactionsByWallet_Call {
	_c.Call.Return(run)
	return _c
}
