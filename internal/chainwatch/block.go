...
// ObservedBlock represents a blockchain block that has been detected by the chainwatch system,
...
//
// This struct is typically used as the primary output of the chainwatch package, enabling
