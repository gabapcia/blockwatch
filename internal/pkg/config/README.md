...
- **Solana**: Solana network via JSON-RPC
...
CHAINSTREAM_NETWORKS_SOLANA_PROVIDER_ENDPOINT=https://api.mainnet-beta.solana.com
CHAINSTREAM_NETWORKS_SOLANA_PROVIDER_TIMEOUT=30s
